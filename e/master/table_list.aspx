               ...
               <ItemTemplate>
                <tr class="listitem">
                  ...
                  <td align=center class=tdstyle>
                    ...
                    <a href="javascript:get_form('<%#DataBinder.Eval(Container.DataItem,"table_name")%>','get_form.aspx?table=<%#DataBinder.Eval(Container.DataItem,"thetable")%>')">获取表单</a>
                    <asp:Button id="Update" runat="server" Text="更新文件"  cssclass="f_bt" CommandName='<%#DataBinder.Eval(Container.DataItem,"thetable")%>' oncommand="Update_File"/>
                   </td>
...
function get_form(name,url)
 {
  General_Set("表名称："+name,url);
 }
</script>
</body>
</html>