...
<asp:Repeater id="DL_1"  runat="server">
   <HeaderTemplate>
     <table border=1>
      <tr><td align=center>title</td><td align=center>pa_jj</td><td align=center>titlepic</td><td align=center>pa_author</td><td align=center>pa_size</td><td align=center>pa_yxhj</td><td align=center>pa_geshi</td><td align=center>pa_jspass</td><td align=center>pa_sqfs</td><td align=center>pa_fj</td><td align=center>content</td><td align=center>thedate</td><td align=center class="clicks">clicks</td><td align=center class="comments">comments</td><td align=center class="downloads">downloads</td><td align=center class="reserves">reserves</td></tr>
   </HeaderTemplate>
   <ItemTemplate>  
      <tr><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"title")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_jj")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"titlepic")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_author")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_size")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_yxhj")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_geshi")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_jspass")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_sqfs")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_fj")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"content")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"thedate")%></td><td align=center class="clicks"><%#DataBinder.Eval(Container.DataItem,"clicks")%></td><td align=center class="comments"><%#DataBinder.Eval(Container.DataItem,"comments")%></td><td align=center class="downloads"><%#DataBinder.Eval(Container.DataItem,"downloads")%></td><td align=center class="reserves"><%#DataBinder.Eval(Container.DataItem,"reserves")%></td></tr>
    </ItemTemplate> 
   <FooterTemplate>
     </table>
   </FooterTemplate>
