...
<asp:Repeater id="DL_1"  runat="server">
   <HeaderTemplate>
     <table border=1>
      <tr><td align=center>pa_position</td><td align=center>title</td><td align=center>titlepic</td><td align=center>pa_xb</td><td align=center>pa_birthday</td><td align=center>pa_sfz</td><td align=center>pa_nation</td><td align=center>pa_zzmm</td><td align=center>pa_marriage</td><td align=center>pa_hometown</td><td align=center>pa_homeaddress</td><td align=center>pa_xl</td><td align=center>pa_graduateschool</td><td align=center>pa_professionalname</td><td align=center>pa_graduationtime</td><td align=center>pa_wysp</td><td align=center>pa_expectationssalary</td><td align=center>pa_computer</td><td align=center>pa_tel</td><td align=center>pa_phone</td><td align=center>email</td><td align=center>pa_address</td><td align=center>thedate</td><td align=center>pa_zwpj</td><td align=center>content</td><td align=center class="clicks">clicks</td><td align=center class="comments">comments</td><td align=center class="downloads">downloads</td><td align=center class="reserves">reserves</td></tr>
   </HeaderTemplate>
   <ItemTemplate>  
      <tr><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_position")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"title")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"titlepic")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_xb")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_birthday")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_sfz")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_nation")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_zzmm")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_marriage")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_hometown")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_homeaddress")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_xl")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_graduateschool")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_professionalname")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_graduationtime")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_wysp")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_expectationssalary")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_computer")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_tel")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_phone")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"email")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_address")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"thedate")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_zwpj")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"content")%></td><td align=center class="clicks"><%#DataBinder.Eval(Container.DataItem,"clicks")%></td><td align=center class="comments"><%#DataBinder.Eval(Container.DataItem,"comments")%></td><td align=center class="downloads"><%#DataBinder.Eval(Container.DataItem,"downloads")%></td><td align=center class="reserves"><%#DataBinder.Eval(Container.DataItem,"reserves")%></td></tr>
    </ItemTemplate> 
   <FooterTemplate>
     </table>
   </FooterTemplate>
