...
<tr><td align=right class='tdhead'>标题样式&nbsp;&nbsp;&nbsp;</td><td><input type=text name='pa_style' id='pa_style' value="<%if(post=="add"){Response.Write("");}else{Response.Write(r("pa_style"));}%>" style=''  maxlength='150'></td></tr>
...
<script type='text/javascript' src='/e/incs/fckeditor/fckeditor.js'></script><script  type='text/javascript'>var FCKeditor = new FCKeditor('pa_content');FCKeditor.BasePath = '/e/incs/fckeditor/';FCKeditor.Height = 380;FCKeditor.Config['LinkUpload'] = true;FCKeditor.Config['ImageUpload'] =true;FCKeditor.Config['FlashUpload'] =true;FCKeditor.Config['LinkBrowser'] = false;FCKeditor.Config['ImageBrowser'] =false;FCKeditor.Config['FlashBrowser'] =false;FCKeditor.ToolbarSet ='Simple';FCKeditor.ReplaceTextarea();</script><tr><td colspan=2 align=center><input type='hidden' name='mustname' value='标题,发布日期,详细内容,'><input type='hidden' name='mustfield' value='title,thedate,pa_content,'><input type='hidden' name='musttype' value='text,text,editor,'></td></tr>
<%End();%>
