...
<asp:Repeater id="DL_1"  runat="server">
   <HeaderTemplate>
     <table border=1>
      <tr><td align=center>title</td><td align=center>pa_xb</td><td align=center>titlepic</td><td align=center>pa_jg</td><td align=center>content</td><td align=center>thedate</td><td align=center>pa_zy</td><td align=center>pa_tel</td><td align=center>pa_adress</td><td align=center class="clicks">clicks</td><td align=center class="comments">comments</td><td align=center class="downloads">downloads</td><td align=center class="reserves">reserves</td></tr>
   </HeaderTemplate>
   <ItemTemplate>  
      <tr><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"title")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_xb")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"titlepic")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_jg")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"content")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"thedate")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_zy")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_tel")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_adress")%></td><td align=center class="clicks"><%#DataBinder.Eval(Container.DataItem,"clicks")%></td><td align=center class="comments"><%#DataBinder.Eval(Container.DataItem,"comments")%></td><td align=center class="downloads"><%#DataBinder.Eval(Container.DataItem,"downloads")%></td><td align=center class="reserves"><%#DataBinder.Eval(Container.DataItem,"reserves")%></td></tr>
    </ItemTemplate> 
   <FooterTemplate>
     </table>
   </FooterTemplate>
