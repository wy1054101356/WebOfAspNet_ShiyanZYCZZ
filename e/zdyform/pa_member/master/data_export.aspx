...
<asp:Repeater id="DL_1"  runat="server">
   <HeaderTemplate>
     <table border=1>
      <tr><td align=center>username</td><td align=center>userpassword</td><td align=center>[xuhao]</td><td align=center>[id]</td><td align=center>email</td><td align=center>mobile</td><td align=center>truename</td><td align=center>pa_tel</td><td align=center>pa_fax</td><td align=center>pa_qq</td><td align=center>pa_msn</td><td align=center>pa_address</td><td align=center>pa_from</td><td align=center>thedate</td></tr>
   </HeaderTemplate>
   <ItemTemplate>  
      <tr><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"username")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"userpassword")%></td><td align=center class="xuhao"><%#xuhao++%></td><td align=center class="id"><%#DataBinder.Eval(Container.DataItem,"id")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"email")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"mobile")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"truename")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_tel")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_fax")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_qq")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_msn")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_address")%></td><td align=center x:str><%#DataBinder.Eval(Container.DataItem,"pa_from")%></td><td align=center><%#DataBinder.Eval(Container.DataItem,"thedate")%></td></tr>
    </ItemTemplate> 
   <FooterTemplate>
     </table>
   </FooterTemplate>
